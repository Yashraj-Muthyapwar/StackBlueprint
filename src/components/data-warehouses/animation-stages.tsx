...
const dwDataJourney: Stage[] = [
  {
    ...
    table: { name: "Events", cols: ["event_type", "payload"], rows: [
      r(1, "click", '{"btn": "checkout"}'),
    ]},
  ...
  },
  {
    ...
    table: { name: "Kafka Topic", cols: ["offset", "msg"], rows: [
      r(1, 101, '{"btn": "checkout"}'),
    ]},
  ...
  },
  {
    ...
    table: { name: "Processed", cols: ["user_id", "action"], rows: [
      r(1, 42, "checkout"),
    ]},
  ...
  },
  {
    ...
    table: { name: "Fact Table", cols: ["date", "sales"], rows: [
      r(1, "2026-06-28", 1500),
    ]},
  ...
  },
  {
    ...
    table: { name: "Dashboard", cols: ["total_revenue"], rows: [
      r(1, 1500),
    ]},
...
const dwOltpVsOlap: Stage[] = [
  {
    ...
    table: { name: "operational_db", cols: ["id", "user", "total"], rows: [
      r(1, 1, 1, 50),
    ]},
    steps: [st([0], "kept", "Fast, simple reads/writes. Optimised for thousands of concurrent users.", { noteTone: "mint" })],
  },
  {
    name: "OLAP (Analyzing the Business)",
    sql: ["SELECT region, SUM(total) FROM orders GROUP BY region;"],
    table: { name: "analytical_db", cols: ["region", "revenue"], rows: [
      r(1, "US", 500000),
    ]},
    steps: [st([0], "kept", "Complex queries over huge historical datasets. Optimised for reporting.", { noteTone: "violet" })],
  },
];
...
const dwStorageTypes: Stage[] = [
  {
    ...
    table: { name: "Library", cols: ["structured_data", "bi_ready"], rows: [
      r(1, "Yes", "Yes"),
    ]},
  ...
  },
  {
    ...
    table: { name: "Garage", cols: ["files", "logs", "images"], rows: [
      r(1, "JSON", "text", "png"),
    ]},
  ...
  },
  {
    ...
    table: { name: "Workshop", cols: ["acid_trans", "cheap_storage"], rows: [
      r(1, "Yes", "Yes"),
    ]},
    steps: [st([0], "kept", "The modern standard: open formats (Iceberg, Delta) on cheap object storage.")],
  },
];
...
const dwOrganizingData: Stage[] = [
  {
    ...
    table: { name: "marketing_mart", cols: ["campaign", "clicks"], rows: [
      r(1, "Summer", 400),
    ]},
  ...
  },
  {
    ...
    table: { name: "data_products", cols: ["domain", "owner"], rows: [
      r(1, "Finance", "finance_team"), r(2, "Ops", "ops_team"),
    ]},
  ...
  },
  {
    ...
    table: { name: "virtual_layer", cols: ["source1", "source2"], rows: [
      r(1, "AWS", "On-Prem"),
    ]},
...
const dwDatabaseFamilies: Stage[] = [
  {
    ...
    table: { name: "SQL", cols: ["ACID", "Schema"], rows: [
      r(1, "Strong", "Rigid"),
    ]},
  ...
  },
  {
    ...
    table: { name: "MongoDB", cols: ["id", "json_blob"], rows: [
      r(1, "doc1", "{...}"),
    ]},
  ...
  },
  {
    ...
    table: { name: "Special", cols: ["type", "use_case"], rows: [
      r(1, "Vector", "AI/RAG"), r(2, "Graph", "Fraud"),
    ]},
