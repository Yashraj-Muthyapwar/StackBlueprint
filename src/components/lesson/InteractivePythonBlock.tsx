...
export function InteractivePythonBlock({ initialCode, caption }: InteractivePythonBlockProps) {
  ...
  return (
    <figure className="group relative overflow-hidden rounded-xl border border-hairline bg-slate-50 dark:bg-surface shadow-sm my-6">
