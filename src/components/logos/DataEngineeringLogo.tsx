...
export function DataEngineeringLogo({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      {/* Background Pipes */}
      <path d="M 0 55 L 240 55" stroke="currentColor" strokeWidth="6" strokeLinecap="round" opacity="0.3" />
      ...
      {/* Directional Arrows */}
      <path d="M 77 48 L 84 55 L 77 62" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.8" />
      <path d="M 147 48 L 154 55 L 147 62" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.8" />

      {/* Tank 1: Ingestion */}
      <g>
        <path d="M 38 90 L 33 100 L 59 100 L 54 90 Z" fill="currentColor" opacity="0.2" />
        <rect x="26" y="20" width="40" height="70" rx="10" fill="url(#tankBg)" stroke="currentColor" strokeWidth="3" />
      ...
      <g>
        ...
        <rect x="96" y="20" width="40" height="70" rx="10" fill="url(#tankBg)" stroke="currentColor" strokeWidth="3" />
      ...
      <g>
        ...
        <rect x="166" y="20" width="40" height="70" rx="10" fill="url(#tankBg)" stroke="currentColor" strokeWidth="3" />
        <path d="M 174 70 L 198 70" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.5" />
