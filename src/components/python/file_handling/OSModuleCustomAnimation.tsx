  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="flex flex-col items-center w-full">
      <div className="mb-6 p-4 rounded-xl border border-sky-500/30 bg-surface shadow-sm w-full max-w-lg text-left font-mono text-[13px] leading-relaxed text-foreground">
        <span className="text-muted-foreground"># Flat iteration (replaces os.listdir)</span><br/>
      ...
      <div className="flex justify-center gap-6 w-full max-w-2xl">
        <div className="flex-1 p-5 rounded-2xl bg-surface border border-hairline flex flex-col shadow-sm font-mono text-sm">
           <h4 className="text-xs uppercase tracking-widest text-sky-500 mb-4 font-bold flex items-center gap-2 border-b border-hairline pb-2"><FolderSearch className="size-4" /> os.scandir()</h4>
           
           <div className="flex flex-col gap-2">
             <div className="flex items-center gap-2 font-bold text-sky-600 dark:text-sky-400"><Folder className="size-4" /> project</div>
             <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} className="flex items-center justify-between pl-6 py-1 rounded bg-sky-500/10 border border-sky-500/20 text-sky-700 dark:text-sky-300">
             ...
             <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8 }} className="flex items-center justify-between pl-6 py-1 rounded bg-sky-500/10 border border-sky-500/20 text-sky-700 dark:text-sky-300">
