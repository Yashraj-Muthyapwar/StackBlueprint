...
import { Cpu, HardDrive, Play, Pause, RotateCcw, ChevronLeft, ChevronRight, ArrowRight, ArrowLeft, Braces, Binary, Server, AlertTriangle, Skull, Terminal, Save, Trash2, ArrowLeftRight } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="mb-10 p-4 rounded-xl border border-violet/30 bg-violet/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-mint">data</span> = {'{'} <span className="text-amber">'user'</span>: <span className="text-amber">'Ada'</span>, <span className="text-amber">'id'</span>: <span className="text-violet">101</span> {'}'}
      </div>
  ...
  return (
    ...
    >
      <div className="mb-10 p-4 rounded-xl border border-sky-500/30 bg-sky-500/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-blue-400">import</span> pickle<br/>
        <span className="text-mint">blob</span> = pickle.dumps(<span className="text-mint">data</span>)
      </div>
...
function Step3Loads() {
  return (
    ...
    >
      <div className="mb-10 p-4 rounded-xl border border-violet/30 bg-violet/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-mint">restored</span> = pickle.loads(<span className="text-mint">blob</span>)
      </div>
      <div className="flex justify-center gap-8 lg:gap-16 w-full max-w-2xl relative">
        <div className="flex flex-col items-center gap-3">
          <div className="p-6 rounded-2xl bg-sky-500/10 border border-sky-500/20 flex flex-col items-center min-w-[200px] shadow-sm relative overflow-hidden">
  ...
  return (
    ...
    >
      <div className="mb-10 p-4 rounded-xl border border-mint/30 bg-mint/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-blue-400">with</span> <span className="text-blue-400">open</span>(<span className="text-amber">'cache.pkl'</span>, <span className="text-amber">'wb'</span>) <span className="text-blue-400">as</span> f:<br/>
      ...
      <div className="flex justify-center gap-8 lg:gap-16 w-full max-w-2xl relative">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="p-6 rounded-2xl bg-mint/10 border border-mint/20 flex flex-col items-center min-w-[200px] shadow-sm relative overflow-hidden">
             ...
             >
                <div className="text-[10px] uppercase font-mono text-muted-foreground mb-2 border-b border-hairline pb-1 w-full text-center">cache.pkl</div>
...
function Step5Load() {
  return (
    ...
    >
      <div className="mb-10 p-4 rounded-xl border border-violet/30 bg-violet/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-blue-400">with</span> <span className="text-blue-400">open</span>(<span className="text-amber">'cache.pkl'</span>, <span className="text-amber">'rb'</span>) <span className="text-blue-400">as</span> f:<br/>
  ...
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-rose-500/30 bg-rose-500/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-rose-400">class</span> <span className="text-amber">MaliciousCode</span>:<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-rose-400">def</span> <span className="text-blue-400">__reduce__</span>(<span className="text-rose-400">self</span>):<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-400">return</span> (os.system, (<span className="text-amber">'rm -rf /'</span>,))
      </div>
  ...
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-sky-500/30 bg-sky-500/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-muted-foreground"># Server receives user upload and loads it</span><br/>
        <span className="text-mint">user_data</span> = pickle.loads(<span className="text-amber">untrusted_bytes</span>)
      </div>
      <div className="flex justify-center gap-12 w-full max-w-2xl relative">
        <div className="flex flex-col items-center gap-3 relative z-10">
          <div className="p-6 rounded-2xl bg-rose-500/10 border border-rose-500/20 flex flex-col items-center min-w-[200px] shadow-sm">
      ...
      <div className="flex justify-center gap-12 w-full max-w-2xl relative">
        ...
        <div className="flex flex-col items-center gap-3 relative z-10">
          ...
          >
             ...
             <span className="font-mono text-[11px] uppercase tracking-[0.2em] text-rose-500 font-semibold">Compromised</span>
             ...
             >
                ...
                <span className="text-[10px] font-mono text-muted-foreground mt-1">Data deleted.</span>
             </motion.div>
          </motion.div>
        </div>
      </div>
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-md text-center">Before the <code className="bg-surface-2 px-1 rounded">loads()</code> function even finishes, the malicious code executes. <strong className="text-rose-400 font-semibold">Never unpickle untrusted data.</strong></p>
    </motion.div>
  )
}
...
function Step9WriteTemp() {
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-sky-500/30 bg-sky-500/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-muted-foreground"># Write to a temporary file first</span><br/>
        <span className="text-blue-400">with</span> <span className="text-blue-400">open</span>(<span className="text-amber">'.cache.pkl.tmp'</span>, <span className="text-amber">'wb'</span>) <span className="text-blue-400">as</span> f:<br/>
...
function Step10Crash() {
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-rose-500/30 bg-rose-500/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-muted-foreground"># If process crashes mid-write...</span><br/>
  ...
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-mint/30 bg-mint/5 font-mono text-sm shadow-sm w-full max-w-lg">
        <span className="text-muted-foreground"># Once write succeeds, atomically replace</span><br/>
        <span className="text-mint">temporary_path</span>.replace(<span className="text-amber">'cache.pkl'</span>)
      </div>
      <div className="flex justify-center gap-12 w-full max-w-2xl relative">
