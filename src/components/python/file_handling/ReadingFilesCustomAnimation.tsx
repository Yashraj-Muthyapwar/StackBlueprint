  ...
  return (
    ...
    >
      <div className="mb-10 p-4 rounded-xl border border-sky-500/30 bg-sky-500/5 font-mono text-[13px] shadow-sm w-full max-w-lg">
        ...
        <span className="text-amber">'poem.txt'</span>) <span className="text-blue-400">as</span>{" "}
        file:
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;content = file.read()
      </div>
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        <code>read()</code> pulls the <strong>entire file</strong> into one massive string.
      </p>
    </motion.div>
  );
}
...
function Step2ReadLine() {
  return (
    ...
    >
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        <code>readline()</code> pulls just one line and advances the cursor to the next line.
      </p>
    </motion.div>
  );
}
...
function Step3ReadLines() {
  return (
    ...
    >
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        <code>readlines()</code> pulls everything into a <strong>list of strings</strong> (each
        element is one line).
      </p>
    </motion.div>
  );
