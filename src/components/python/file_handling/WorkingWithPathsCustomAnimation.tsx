  ...
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-violet/30 bg-violet/5 font-mono text-[13px] shadow-sm w-full max-w-lg">
        <span className="text-muted-foreground"># Absolute path</span>
        <br />
        <span className="text-amber">/Users/sam/project/data/contacts.txt</span>
        <br />
        <br />
        <span className="text-muted-foreground"># Relative path (starts from CWD)</span>
        <br />
      ...
      <div className="flex w-full max-w-lg items-center justify-center p-6 rounded-2xl bg-surface border border-hairline shadow-sm">
        <div className="flex flex-col gap-2 font-mono text-[13px]">
          <div className="flex items-center gap-2 text-muted-foreground">
            <Folder className="size-4" /> Users
          </div>
          <div className="flex items-center gap-2 pl-4 text-muted-foreground">
            <ArrowDownRight className="size-3 opacity-50" /> <Folder className="size-4" /> sam
          </div>
          <div className="flex items-center gap-2 pl-8 font-semibold text-mint">
            <ArrowDownRight className="size-3 opacity-50" /> <FolderOpen className="size-4" />{" "}
            project (CWD)
          </div>
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <ArrowDownRight className="size-3 opacity-50" /> <FileText className="size-4" />{" "}
            contacts.txt
          </motion.div>
        </div>
      </div>
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        Absolute paths trace from the root. Relative paths start at your current folder.
      </p>
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-sky-500/30 bg-sky-500/5 font-mono text-[13px] shadow-sm w-full max-w-lg">
        <span className="text-blue-400">from</span> pathlib{" "}
        <span className="text-blue-400">import</span> Path
        <br />
        <br />
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        <code className="bg-surface-2 px-1 rounded">cwd()</code> (Current Working Directory) is the
        folder you are in when you run the command, NOT always where the script lives.
      </p>
    </motion.div>
  );
}
    ...
    >
      ...
      <div className="flex justify-center items-center gap-4 w-full max-w-lg">
        ...
        <motion.div
          ...
          transition={{ delay: 0.8 }}
        >
          <div className="flex items-center justify-center size-8 rounded-full bg-amber/20 text-amber font-mono font-bold text-lg">
            /
          </div>
        </motion.div>
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        The <code className="bg-surface-2 px-1 rounded">/</code> operator joins parts safely, using{" "}
        <code className="bg-surface-2 px-1 rounded">\</code> on Windows and{" "}
        <code className="bg-surface-2 px-1 rounded">/</code> on Mac/Linux.
      </p>
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-mint/30 bg-mint/5 font-mono text-[13px] shadow-sm w-full max-w-lg">
        contacts_path.parent.mkdir(exist_ok=<span className="text-mint">True</span>)<br />
        <br />
        <span className="text-blue-400">with</span> contacts_path.open(
        <span className="text-amber">'w'</span>) <span className="text-blue-400">as</span> file:
        <br />
      ...
      <div className="flex gap-4 items-end justify-center w-full max-w-lg">
        <div className="flex flex-col gap-2 font-mono text-[13px] p-6 rounded-2xl bg-surface border border-hairline shadow-sm flex-1">
          ...
          >
            <ArrowDownRight className="size-3 opacity-50" /> <Folder className="size-4" /> data{" "}
            <span className="text-[10px] uppercase ml-auto tracking-wider text-violet/70">
              mkdir()
            </span>
          </motion.div>
          <motion.div
          ...
          >
            <ArrowDownRight className="size-3 opacity-50" /> <FileText className="size-4" />{" "}
            contacts.txt{" "}
            <span className="text-[10px] uppercase ml-auto tracking-wider text-amber/70">
              open('w')
            </span>
          </motion.div>
        </div>
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        You cannot write a file into a folder that doesn't exist yet! Create{" "}
        <code className="bg-surface-2 px-1 rounded">parent</code> folders first.
      </p>
    </motion.div>
  );
}
...
function Step5Properties() {
  return (
    ...
    >
      <div className="mb-8 p-4 rounded-xl border border-sky-500/30 bg-sky-500/5 font-mono text-[13px] shadow-sm w-full max-w-lg">
        report = exports / <span className="text-amber">'contacts-august.txt'</span>
        <br />
        <br />
        <span className="text-mint">print</span>(report.name) &nbsp;&nbsp;&nbsp;
        <span className="text-muted-foreground"># contacts-august.txt</span>
        <br />
        <span className="text-mint">print</span>(report.stem) &nbsp;&nbsp;&nbsp;
        <span className="text-muted-foreground"># contacts-august</span>
        <br />
        <span className="text-mint">print</span>(report.suffix) &nbsp;
      ...
      <div className="flex w-full max-w-lg items-center justify-center p-6 rounded-2xl bg-surface border border-hairline shadow-sm">
        <div className="flex flex-col gap-4 font-mono text-sm w-full">
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <div className="flex-1 bg-surface-2 p-2 rounded break-all">
              .../exports/<span className="text-sky-400 font-bold">contacts-august</span>
              <span className="text-amber font-bold">.txt</span>
            </div>
          </div>
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        Path objects make it trivial to extract extensions or base names without fragile string
        splitting.
      </p>
    </motion.div>
  );
  ...
  return (
    ...
    >
      <div className="mb-6 p-4 rounded-xl border border-violet/30 bg-violet/5 font-mono text-[13px] shadow-sm w-full max-w-lg">
        <span className="text-blue-400">for</span> file_path{" "}
        <span className="text-blue-400">in</span> Path(<span className="text-amber">'.'</span>
        ).rglob(<span className="text-amber">'*.txt'</span>):
        <br />
        ...
        <div className="flex flex-col gap-2 font-mono text-[13px] w-full">
          <div className="flex items-center justify-between text-muted-foreground">
            <div className="flex items-center gap-2">
              <FolderOpen className="size-4" /> project (CWD)
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pl-4 text-muted-foreground mt-2">
            <div className="flex items-center gap-2">
              <FolderOpen className="size-4" /> exports
            </div>
          </div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 0.5 }}
            className="flex items-center justify-between pl-8 text-amber bg-amber/10 rounded px-2 py-1"
          >
            <div className="flex items-center gap-2">
              <FileText className="size-4" /> contacts-june.txt
            </div>
          ...
          <div className="flex items-center justify-between pl-8 text-muted-foreground opacity-50 px-2 py-1">
            <div className="flex items-center gap-2">
              <FileText className="size-4" /> data.csv
            </div>
          ...
          >
            <div className="flex items-center gap-2">
              <FileText className="size-4" /> contacts-july.txt
            </div>
            <div className="text-[10px] uppercase tracking-wider">MATCH</div>
          </motion.div>
        </div>
      ...
      <p className="mt-8 text-sm text-muted-foreground/80 max-w-sm text-center">
        <code className="bg-surface-2 px-1 rounded">rglob()</code> recursively searches all
        subfolders for files matching the pattern.
      </p>
    </motion.div>
  );
}
