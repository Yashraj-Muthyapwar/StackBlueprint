export function CarSVG({ className, color = "currentColor", bodyClass = "" }: { className?: string, color?: string, bodyClass?: string }) {
  return (
    <svg viewBox="0 0 200 90" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Rear Wheel Well */}
      <path d="M 30 70 A 15 15 0 0 1 60 70" fill="none" stroke="black" strokeOpacity="0.2" strokeWidth="4" />
      {/* Rear Wheel */}
      ...
      {/* Front Wheel Well */}
      <path d="M 140 70 A 15 15 0 0 1 170 70" fill="none" stroke="black" strokeOpacity="0.2" strokeWidth="4" />
      {/* Front Wheel */}
      ...
      {/* Body Line */}
      <path d="M 25 45 L 185 45" stroke="black" strokeOpacity="0.1" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
