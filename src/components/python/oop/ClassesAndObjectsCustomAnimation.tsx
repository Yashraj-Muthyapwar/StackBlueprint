  ...
  return (
    ...
    >
      <div className="flex w-full max-w-4xl gap-16 items-center justify-center">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <motion.div className="w-56 aspect-[4/5] rounded-3xl border border-blue-500/40 bg-gradient-to-br from-blue-500/10 to-transparent shadow-[0_0_40px_rgba(59,130,246,0.15)] backdrop-blur-md p-6 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="font-mono text-[10px] text-blue-400/80 z-10">
              Defines shape & features
            </div>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center relative w-16 h-32">
          <svg className="w-full h-full absolute" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            />
            <path
              d="M 85 45 L 95 50 L 85 55 Z"
              fill="currentColor"
              className="text-muted-foreground/30"
            />
          </svg>
          <div className="bg-surface-2/80 backdrop-blur-sm px-2 py-1 rounded text-[10px] font-mono text-muted-foreground z-10 border border-hairline mt-10">
            Instantiates
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="relative w-64 h-72 flex items-center justify-center">
            ...
            >
              <div className="font-mono text-[9px] text-rose-400/80 uppercase tracking-widest mb-auto w-full text-center">
                Object A
              </div>
              <CarSVG className="w-full h-auto drop-shadow-md my-auto" color="#f43f5e" />
              <div className="w-full mt-auto bg-rose-500/10 border border-rose-500/20 rounded py-1 text-center font-mono text-[9px] text-rose-400">
                color: "red"
              </div>
            </motion.div>
            ...
            >
              <div className="font-mono text-[9px] text-emerald-400/80 uppercase tracking-widest mb-auto w-full text-center">
                Object B
              </div>
              <CarSVG className="w-full h-auto drop-shadow-md my-auto" color="#10b981" />
              <div className="w-full mt-auto bg-emerald-500/10 border border-emerald-500/20 rounded py-1 text-center font-mono text-[9px] text-emerald-400">
                color: "green"
              </div>
            </motion.div>
            ...
            >
              <div className="font-mono text-[9px] text-amber/80 uppercase tracking-widest mb-auto w-full text-center">
                Object C
              </div>
              <CarSVG className="w-full h-auto drop-shadow-md my-auto" color="#fbbf24" />
              <div className="w-full mt-auto bg-amber/10 border border-amber/20 rounded py-1 text-center font-mono text-[9px] text-amber">
                color: "yellow"
              </div>
            </motion.div>
          </div>
      ...
      <p className="mt-12 text-sm text-muted-foreground/80 max-w-lg text-center">
        ...
        Before looking at code, remember the core concept: A{" "}
        <strong className="text-foreground">Class</strong> is just a blueprint. An{" "}
    ...
    >
      <div className="flex w-full max-w-4xl gap-12 items-center justify-center">
        ...
        <div className="flex-1 p-6 bg-surface-2/80 backdrop-blur border border-hairline rounded-2xl shadow-xl font-mono text-[13px] leading-relaxed">
          ...
          <span className="text-mint font-bold">Car</span>:<br />
          &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-400">def</span>{" "}
          <span className="text-blue-400">__init__</span>(
          <span className="text-rose-400">self</span>, brand, speed):
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span className="text-rose-400">self</span>.brand = brand
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span className="text-rose-400">self</span>.speed = speed
          <br />
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-400">def</span>{" "}
          <span className="text-violet">drive</span>(<span className="text-rose-400">self</span>):
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span className="text-blue-400">print</span>(<span className="text-amber">f"</span>
          {"{"}
          <span className="text-rose-400">self</span>.brand{"}"}
          <span className="text-amber"> is driving."</span>)
        </div>

        {/* Visual Blueprint */}
        <div className="flex-1 flex justify-center relative">
          <motion.div
            layoutId="blueprint_card"
            className="w-64 aspect-[4/5] rounded-3xl border border-blue-500/40 bg-gradient-to-br from-blue-500/10 to-transparent shadow-[0_0_40px_rgba(59,130,246,0.15)] backdrop-blur-md p-6 flex flex-col"
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 bg-blue-500/20 rounded-xl text-blue-400">
                <Layers className="size-5" />
              </div>
              <div className="font-mono text-xs text-blue-400 uppercase tracking-widest font-semibold">
                Blueprint
              </div>
            </div>
            ...
            <div className="w-full h-10 rounded-xl bg-violet/10 border border-violet/20 flex items-center justify-center mt-auto">
              <span className="font-mono text-xs text-violet font-semibold tracking-wider">
                drive()
              </span>
            </div>
          </motion.div>
      ...
      <p className="mt-12 text-sm text-muted-foreground/80 max-w-lg text-center">
        A class is a theoretical blueprint. It defines what data it{" "}
        <span className="italic">will</span> hold and what actions it{" "}
        <span className="italic">can</span> perform, but it doesn't hold actual data itself.
      </p>
    </motion.div>
  );
}
...
function Step3Objects() {
  return (
    ...
    >
      <div className="flex w-full max-w-4xl gap-12 items-center justify-center">
        ...
        <div className="flex-1 p-6 bg-surface-2/80 backdrop-blur border border-hairline rounded-2xl shadow-xl font-mono text-[13px] leading-relaxed relative overflow-hidden">
          <div className="relative z-10">
            car1 = <span className="text-mint font-bold">Car</span>(
            <span className="text-amber">"Toyota"</span>, <span className="text-mint">120</span>)
            <br />
            car2 = <span className="text-mint font-bold">Car</span>(
            <span className="text-amber">"Ford"</span>, <span className="text-mint">140</span>)
            <br />
            <br />
            <span className="text-blue-400">print</span>(car1.brand){" "}
            <span className="text-muted-foreground"># "Toyota"</span>
            <br />
            <span className="text-blue-400">print</span>(car2.brand){" "}
            <span className="text-muted-foreground"># "Ford"</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex gap-6 items-center justify-center relative h-80">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="font-mono text-[10px] text-amber font-semibold bg-amber/10 px-2 py-1 rounded w-fit">
                car1
              </div>
            ...
            <div className="space-y-3 mt-auto">
              <div className="w-full bg-amber/5 rounded-lg p-2 flex justify-between items-center text-xs font-mono border border-amber/20">
                ...
                <span className="text-amber">"Toyota"</span>
              </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="font-mono text-[10px] text-mint font-semibold bg-mint/10 px-2 py-1 rounded w-fit">
                car2
              </div>
              <Fingerprint className="size-4 text-muted-foreground opacity-50" />
            </div>
            ...
            <div className="space-y-3 mt-auto">
              <div className="w-full bg-amber/5 rounded-lg p-2 flex justify-between items-center text-xs font-mono border border-amber/20">
                <span className="text-muted-foreground">brand</span>{" "}
                <span className="text-amber">"Ford"</span>
              </div>
              <div className="w-full bg-surface-2 rounded-lg p-2 flex justify-between items-center text-xs font-mono border border-hairline">
                <span className="text-muted-foreground">speed</span>{" "}
      ...
      <p className="mt-12 text-sm text-muted-foreground/80 max-w-lg text-center">
        Calling the class creates instances (objects). They are independent entities living in
        memory that share the same blueprint structure but hold their own unique state.
      </p>
    </motion.div>
  );
}
      ...
      <div className="flex w-full max-w-4xl gap-12 items-center justify-center">
        ...
        <div className="flex-1 flex gap-8 items-center justify-center relative h-80">
          <motion.div className="w-56 aspect-[4/5] rounded-2xl border border-amber/30 bg-surface shadow-2xl backdrop-blur-md p-6 flex flex-col relative z-20">
            <div className="font-mono text-[10px] text-amber font-semibold bg-amber/10 px-2 py-1 rounded w-fit mb-2">
              car1
            </div>
          ...
          >
            ...
            <div className="text-xs font-mono text-foreground/80 leading-relaxed mt-1">
              Python passes <span className="text-amber font-semibold">car1</span> into{" "}
              <span className="text-rose-400 font-semibold bg-rose-400/10 px-1 rounded">self</span>{" "}
              automatically.
            </div>
          </motion.div>
        </div>
      </div>
      <p className="mt-12 text-sm text-muted-foreground/80 max-w-xl text-center">
        Objects carry both their data and their capabilities. Methods act on the object's own
        distinct data (via <code className="bg-surface-2 px-1 rounded">self</code>).
      </p>
    </motion.div>
  );
}
    ...
    >
      <div className="flex w-full max-w-[900px] gap-2 md:gap-8 items-center justify-center scale-[0.65] sm:scale-[0.8] md:scale-90 lg:scale-100 origin-center">
        ...
        <div className="flex justify-center items-center w-16 md:w-20 flex-shrink-0">
          ...
          >
            <div
              className="w-16 md:w-20 h-10 md:h-12 bg-gradient-to-r from-blue-500/0 via-blue-500/50 to-blue-500 flex items-center justify-end pr-1 rounded-r-full relative overflow-hidden"
              style={{
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <div className="px-5 pb-5 pt-12 space-y-5">
                <div>
                  <div className="text-[11px] text-blue-400 font-semibold mb-2 uppercase tracking-wider">
                    Attributes (Data)
                  </div>
            ...
            >
              <svg
                className="w-8 h-8 text-blue-400 transform -rotate-[20deg]"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
              ...
              <span className="font-writing text-blue-400 text-xs leading-tight ml-1">
                One object.
                <br />
                All related.
                <br />
