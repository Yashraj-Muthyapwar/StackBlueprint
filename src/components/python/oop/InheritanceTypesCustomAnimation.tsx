    ...
    >
      ...
      <div className="flex flex-row w-full gap-8 items-center justify-center">
        ...
        <div className="relative w-[320px] h-[250px] shrink-0">
          <motion.div
            className="absolute top-[20px] left-[160px] -translate-x-1/2 z-20"
          ...
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 320 250">
            ...
            <motion.circle
              ...
              style={{
                ...
                offsetPath: 'path("M 160,68 L 160,120")',
              }}
          ...
          <motion.div
            className="absolute top-[120px] left-[160px] -translate-x-1/2 z-20"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
        ...
        <div className="w-[380px] shrink-0 bg-surface-2/30 rounded-lg p-4 font-mono text-xs border border-hairline relative text-left">
          <pre className="text-left leading-relaxed whitespace-pre-wrap">
            ...
            <span className="text-amber-600">introduce</span>(self):{"\n"}
            {"        "}
            ...
            <span className="text-emerald-600">Employee</span>):{"\n"}
            {"    "}
            <span className="text-pink-600">def</span>{" "}
            <span className="text-amber-600">write_code</span>(self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
          </pre>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row w-full gap-8 items-center justify-center">
        ...
        <div className="relative w-[320px] h-[250px] shrink-0">
          <motion.div
            className="absolute top-[20px] left-[80px] -translate-x-1/2 z-20"
            initial={{ y: -20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.1 }}
          >
          ...
          <motion.div
            className="absolute top-[20px] left-[240px] -translate-x-1/2 z-20"
            initial={{ y: -20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 320 250">
            ...
            <motion.circle
              ...
              style={{
                ...
                offsetPath: 'path("M 80,68 L 160,120")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 0.8 }}
            />
            <motion.circle
              ...
              style={{
                ...
                offsetPath: 'path("M 240,68 L 160,120")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
        ...
        <div className="w-[380px] shrink-0 bg-surface-2/30 rounded-lg p-4 font-mono text-xs border border-hairline relative text-left">
          <pre className="text-left leading-relaxed whitespace-pre-wrap">
            <span className="text-pink-600">class</span>{" "}
            <span className="text-blue-600">Writer</span>:{"\n"}
            {"    "}
            <span className="text-pink-600">def</span> <span className="text-amber-600">write</span>
            (self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
            {"\n"}
            {"\n"}
            <span className="text-pink-600">class</span>{" "}
            <span className="text-blue-600">Speaker</span>:{"\n"}
            {"    "}
            <span className="text-pink-600">def</span> <span className="text-amber-600">speak</span>
            (self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
            {"\n"}
            {"\n"}
            <span className="text-pink-600">class</span>{" "}
            <span className="text-blue-600">Presenter</span>(
            <span className="text-amber-600">Writer</span>,{" "}
            <span className="text-rose-600">Speaker</span>):{"\n"}
            {"    "}
            <span className="text-pink-600">pass</span>
            {"\n"}
            {"\n"}
            <span className="text-indigo-500">print</span>(
            <span className="text-blue-600">Presenter</span>.mro()){"\n"}
            <span className="text-muted-foreground">
              # [&lt;class 'Presenter'&gt;, &lt;class 'Writer'&gt;, &lt;class 'Speaker'&gt;,
              &lt;class 'object'&gt;]
            </span>
          </pre>
        </div>
...
function Step2Multilevel() {
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-8 text-center max-w-md">
        Inheriting from a class that already inherits from another class.
      </p>
      ...
      <div className="flex flex-row w-full gap-8 items-center justify-center">
        ...
        <div className="relative w-[320px] h-[250px] shrink-0">
          ...
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 320 250">
            ...
            <motion.circle
              ...
              style={{
                ...
                offsetPath: 'path("M 160,68 L 160,110")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 0.8 }}
            />
          ...
          <motion.div
            className="absolute top-[110px] left-[160px] -translate-x-1/2 z-20"
          ...
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 320 250">
            ...
            <motion.circle
              ...
              style={{
                filter: "drop-shadow(0 0 4px #3b82f6)",
                offsetPath: 'path("M 160,158 L 160,200")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
          ...
          <motion.div
            className="absolute top-[200px] left-[160px] -translate-x-1/2 z-20"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
        ...
        <div className="w-[380px] shrink-0 bg-surface-2/30 rounded-lg p-4 font-mono text-xs border border-hairline relative text-left">
          <pre className="text-left leading-relaxed whitespace-pre-wrap">
            ...
            {"    "}
            <span className="text-pink-600">def</span> <span className="text-amber-600">move</span>
            (self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
            {"\n"}
            {"\n"}
            <span className="text-pink-600">class</span> <span className="text-blue-600">Car</span>(
            <span className="text-slate-400">Vehicle</span>):{"\n"}
            {"    "}
            <span className="text-pink-600">def</span> <span className="text-amber-600">drive</span>
            (self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
            {"\n"}
            {"\n"}
            <span className="text-pink-600">class</span>{" "}
            <span className="text-blue-600">ElectricCar</span>(
            <span className="text-blue-600">Car</span>):{"\n"}
            {"    "}
            <span className="text-pink-600">def</span>{" "}
            <span className="text-amber-600">charge</span>(self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
          </pre>
        </div>
    ...
    >
      ...
      <div className="flex flex-row w-full gap-8 items-center justify-center">
        ...
        <div className="relative w-[320px] h-[250px] shrink-0">
          ...
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 320 250">
            <motion.path
              d="M 160,68 L 160,90 L 80,90 L 80,120"
              fill="none"
              stroke="var(--hairline)"
              strokeWidth="3"
              initial={{ pathLength: 0 }}
            ...
            />
            <motion.path
              d="M 160,68 L 160,90 L 240,90 L 240,120"
              fill="none"
              stroke="var(--hairline)"
              strokeWidth="3"
              initial={{ pathLength: 0 }}
            ...
            <motion.circle
              ...
              style={{
                filter: "drop-shadow(0 0 4px #3b82f6)",
                offsetPath: 'path("M 160,68 L 160,90 L 80,90 L 80,120")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 0.8 }}
            />
            <motion.circle
              ...
              style={{
                filter: "drop-shadow(0 0 4px #3b82f6)",
                offsetPath: 'path("M 160,68 L 160,90 L 240,90 L 240,120")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 0.9 }}
            />
          ...
          <motion.div
            className="absolute top-[120px] left-[80px] -translate-x-1/2 z-20"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.7 }}
          >
          ...
          <motion.div
            className="absolute top-[120px] left-[240px] -translate-x-1/2 z-20"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
        ...
        <div className="w-[380px] shrink-0 bg-surface-2/30 rounded-lg p-4 font-mono text-xs border border-hairline relative text-left">
          <pre className="text-left leading-relaxed whitespace-pre-wrap">
            ...
            {"    "}
            <span className="text-pink-600">def</span>{" "}
            <span className="text-amber-600">create_design</span>(self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
          </pre>
        </div>
    ...
    >
      ...
      <div className="flex flex-row w-full gap-8 items-center justify-center">
        ...
        <div className="relative w-[320px] h-[250px] shrink-0 scale-95 origin-top">
          <motion.div
            className="absolute top-[10px] left-[160px] -translate-x-1/2 z-20"
            initial={{ y: -20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.1 }}
          >
          ...
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 320 250">
            <motion.path
              d="M 160,58 L 160,75 L 80,75 L 80,95"
              fill="none"
              stroke="var(--hairline)"
              strokeWidth="3"
              initial={{ pathLength: 0 }}
            ...
            />
            <motion.path
              d="M 160,58 L 160,75 L 240,75 L 240,95"
              fill="none"
              stroke="var(--hairline)"
              strokeWidth="3"
              initial={{ pathLength: 0 }}
            ...
            <motion.circle
              ...
              style={{
                filter: "drop-shadow(0 0 4px #3b82f6)",
                offsetPath: 'path("M 160,58 L 160,75 L 80,75 L 80,95")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
            ...
            <motion.circle
              ...
              style={{
                filter: "drop-shadow(0 0 4px #3b82f6)",
                offsetPath: 'path("M 160,58 L 160,75 L 240,75 L 240,95")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 0.8 }}
            />
          ...
          <motion.div
            className="absolute top-[95px] left-[80px] -translate-x-1/2 z-20"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.5 }}
          >
          ...
          <motion.div
            className="absolute top-[95px] left-[240px] -translate-x-1/2 z-20"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.5 }}
          >
          ...
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 320 250">
            <motion.path
              d="M 80,143 L 80,165 L 160,165 L 160,185"
              fill="none"
              stroke="var(--hairline)"
              strokeWidth="3"
              initial={{ pathLength: 0 }}
            ...
            />
            <motion.path
              d="M 240,143 L 240,165 L 160,165 L 160,185"
              fill="none"
              stroke="var(--hairline)"
              strokeWidth="3"
              initial={{ pathLength: 0 }}
            ...
            <motion.circle
              ...
              style={{
                ...
                offsetPath: 'path("M 80,143 L 80,165 L 160,165 L 160,185")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
              transition={{ duration: 1.5, repeat: Infinity, delay: 1.2 }}
            />
            <motion.circle
              ...
              style={{
                ...
                offsetPath: 'path("M 240,143 L 240,165 L 160,165 L 160,185")',
              }}
              animate={{ offsetDistance: ["0%", "100%"] }}
          ...
          <motion.div
            className="absolute top-[185px] left-[160px] -translate-x-1/2 z-20"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 1 }}
          >
        ...
        <div className="w-[380px] shrink-0 bg-surface-2/30 rounded-lg p-4 font-mono text-xs border border-hairline relative text-left">
          <pre className="text-left leading-relaxed whitespace-pre-wrap">
            ...
            {"\n"}
            <span className="text-pink-600">class</span>{" "}
            <span className="text-blue-600">TeamLead</span>(
            <span className="text-emerald-600">Developer</span>,{" "}
            <span className="text-purple-600">Designer</span>):{"\n"}
            {"    "}
            <span className="text-pink-600">def</span>{" "}
            <span className="text-amber-600">manage_team</span>(self):{"\n"}
            {"        "}
            <span className="text-muted-foreground"># ...</span>
            {"\n"}
            {"\n"}
            <span className="text-indigo-500">print</span>(
            <span className="text-blue-600">TeamLead</span>.mro()){"\n"}
            <span className="text-muted-foreground">
              # [&lt;class 'TeamLead'&gt;, &lt;class 'Developer'&gt;, &lt;class 'Designer'&gt;,
...
function NodeCard({ icon: Icon, title, color }: { icon: any; title: string; color: string }) {
  const colors: Record<string, string> = {
    ...
    purple:
      "text-purple-500 border-purple-500/30 bg-purple-500/10 shadow-[0_0_15px_rgba(168,85,247,0.15)]",
    amber:
    ...
    indigo:
      "text-indigo-500 border-indigo-500/30 bg-indigo-500/10 shadow-[0_0_15px_rgba(99,102,241,0.15)]",
    slate:
      "text-slate-500 border-slate-500/30 bg-slate-500/10 shadow-[0_0_15px_rgba(100,116,139,0.15)]",
  };

  return (
    <div
      className={cn(
        "p-2.5 rounded-xl border-2 flex items-center justify-center gap-2 backdrop-blur-md w-28 h-12 relative overflow-hidden",
        colors[color],
      )}
    >
      <motion.div
