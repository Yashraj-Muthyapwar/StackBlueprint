  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-12 text-center">
        A <span className="text-emerald-500 font-bold">Class Attribute</span> is shared.
        <br />
        An <span className="text-blue-500 font-bold">Instance Attribute</span> is unique to one
        object.
      </p>
      ...
      <div className="relative flex flex-col items-center w-full">
        ...
        >
          ...
          <div className="font-mono text-sm text-foreground">
            ...
            <span className="text-amber-500">"Stack Blueprint"</span>
          </div>
          <div className="absolute -top-3 -right-2 px-2 py-0.5 bg-emerald-500 text-white font-bold text-[10px] rounded-full uppercase tracking-wider">
            Shared
          </div>
        </motion.div>
        ...
        {/* SVG Connectors */}
        <svg
          className="absolute top-10 left-0 w-full h-24 pointer-events-none opacity-40 z-0"
          viewBox="0 0 600 100"
        >
          <path
            d="M300,0 C300,50 150,50 150,100"
            fill="none"
            stroke="#10b981"
            strokeWidth="2"
            strokeDasharray="4 4"
          />
          <path
            d="M300,0 C300,50 300,50 300,100"
            fill="none"
            stroke="#10b981"
            strokeWidth="2"
            strokeDasharray="4 4"
          />
          <path
            d="M300,0 C300,50 450,50 450,100"
            fill="none"
            stroke="#10b981"
            strokeWidth="2"
            strokeDasharray="4 4"
  ...
  return (
    ...
    >
      <h3 className="text-xl font-bold font-mono mb-2 text-foreground">
        Instance Attributes are Isolated
      </h3>
      ...
      <div className="relative font-mono text-sm bg-surface border border-hairline rounded-lg px-4 py-2 mb-8 shadow-sm">
        <span className="text-blue-500">employee1</span>.
        <span className="text-foreground">salary</span> ={" "}
        <span className="text-violet-500">75000</span>
      </div>

      <div className="flex gap-12 relative z-10 w-full justify-center">
        {/* Maya */}
        <motion.div className="w-48 bg-surface border-2 border-blue-500/50 rounded-xl overflow-hidden shadow-[0_0_20px_rgba(59,130,246,0.15)] relative">
          ...
          <div className="p-4 space-y-3">
            ...
            <motion.div
              animate={{
                backgroundColor:
                  val === "75000"
                    ? ["rgba(167,139,250,0.4)", "var(--surface-2)"]
                    : "var(--surface-2)",
        ...
        {/* Leo */}
        <motion.div className="w-48 bg-surface border border-hairline rounded-xl overflow-hidden shadow-sm relative opacity-70">
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center w-full">
        ...
        {/* SVG Connectors */}
        <svg
          className="absolute top-10 left-0 w-full h-24 pointer-events-none opacity-60 z-0"
          viewBox="0 0 600 100"
        >
          <path
          ...
          {company === '"Stack Blueprint"' && (
            <>
              <motion.circle
                ...
                style={{ offsetPath: 'path("M300,10 Q200,50 200,100")' }}
              />
              <motion.circle
                cx="400"
                cy="100"
                ...
                animate={{ offsetDistance: "100%" }}
                transition={{ duration: 0.8 }}
                style={{ offsetPath: 'path("M300,10 Q400,50 400,100")' }}
              />
            </>
          )}
        </svg>
        ...
        <div className="flex gap-20 mt-16 relative z-10 w-full justify-center">
          {[1, 2].map((idx) => (
            <div
              key={idx}
              className="w-40 bg-surface border border-hairline rounded-xl overflow-hidden shadow-sm"
            >
...
function Step3Sorting() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-8 text-center">
        Does the value differ per object, or is it a shared default?
      </p>
      ...
      <div className="relative w-full h-64 flex justify-between px-10">
        ...
        <div className="w-56 h-full flex flex-col items-center justify-end pb-4 border-2 border-dashed border-blue-500/30 rounded-2xl bg-blue-500/5 relative">
          <div className="absolute top-4 left-1/2 -translate-x-1/2 font-bold font-mono text-blue-500 tracking-wider">
            INSTANCE
          </div>
            ...
            <AnimatePresence>
              {phase >= 1 && (
                <motion.div
                  ...
                  className="bg-blue-600/80 text-white font-mono text-sm py-2 px-3 rounded-md text-center shadow-sm"
                >
                  name
                </motion.div>
              )}
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center -top-32 text-foreground">
          <AnimatePresence mode="popLayout">
            {phase === 0 && (
              <motion.div
                exit={{ scale: 0 }}
                className="bg-surface border border-hairline font-mono text-sm py-2 px-6 rounded-md shadow-lg font-bold"
              >
                name
              </motion.div>
            )}
        ...
        <div className="w-56 h-full flex flex-col items-center justify-end pb-4 border-2 border-dashed border-emerald-500/30 rounded-2xl bg-emerald-500/5 relative">
          <div className="absolute top-4 left-1/2 -translate-x-1/2 font-bold font-mono text-emerald-500 tracking-wider">
            CLASS
          </div>
          <div className="w-full px-4 flex flex-col gap-2">
            <AnimatePresence>
              {phase >= 2 && (
                <motion.div
                  initial={{ y: -100, opacity: 0 }}
                  animate={{ y: 0, opacity: 1 }}
                  className="bg-emerald-600/80 text-white font-mono text-sm py-2 px-3 rounded-md text-center shadow-sm"
                >
                  tax_rate
                </motion.div>
              )}
...
function Step4ProductExample() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-6 text-center">
        Products have different prices, but share the same tax rate.
      </p>
      ...
      <div className="relative flex flex-col items-center w-full">
        ...
        >
          <span className="text-[10px] text-emerald-500 uppercase tracking-widest mb-1 font-bold">
            Class Attribute
          </span>
        ...
        {/* SVG Connectors */}
        <svg
          className="absolute top-10 left-0 w-full h-32 pointer-events-none opacity-50 z-0"
          viewBox="0 0 600 150"
        >
          <path
            d="M300,15 Q200,80 200,130"
            fill="none"
            stroke="#10b981"
            strokeWidth="2"
            strokeDasharray="6 6"
          ...
          {tax === "0.09" && (
            <>
              <motion.circle
                ...
                animate={{ offsetDistance: "100%" }}
                transition={{ duration: 0.8 }}
                style={{ offsetPath: 'path("M300,15 Q200,80 200,130")' }}
              />
              <motion.circle
                cx="400"
                cy="130"
                ...
                animate={{ offsetDistance: "100%" }}
                transition={{ duration: 0.8 }}
                style={{ offsetPath: 'path("M300,15 Q400,80 400,130")' }}
              />
            </>
          )}
        </svg>
