      ...
      <div className="flex justify-center gap-6 w-full">
         ...
         >
            <div className="bg-blue-500/10 py-3 border-b border-blue-500/30 flex flex-col items-center gap-2">
              <span className="font-mono text-sm text-blue-500 font-bold uppercase tracking-wider">Instance Method</span>
            </div>
         ...
         >
            <div className="bg-emerald-500/10 py-3 border-b border-emerald-500/30 flex flex-col items-center gap-2">
              <span className="font-mono text-sm text-emerald-500 font-bold uppercase tracking-wider">Class Method</span>
            </div>
            <div className="p-5 flex flex-col items-center text-center space-y-4">
         ...
         >
            <div className="bg-violet-500/10 py-3 border-b border-violet-500/30 flex flex-col items-center gap-2">
              <span className="font-mono text-sm text-violet-500 font-bold uppercase tracking-wider">Static Method</span>
            </div>
            <div className="p-5 flex flex-col items-center text-center space-y-4">
...
function Step1InstanceMethod() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-8 text-center">Uses <code className="text-blue-500">self</code> to access object-specific data.</p>
      ...
      <div className="relative font-mono text-sm bg-surface border border-hairline rounded-lg px-4 py-3 mb-10 shadow-sm w-[350px]">
        ...
        <span className="text-blue-500">laptop</span>.<span className="text-amber-500">display_details</span>()
      </div>
      ...
      <div className="flex justify-between items-center w-full max-w-2xl relative z-10 px-10">
        ...
        <div className="flex flex-col items-center justify-center flex-1 relative h-32">
           <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 200 100">
              <path d="M 0,50 L 200,50" fill="none" stroke="currentColor" strokeOpacity="0.2" strokeWidth="2" strokeDasharray="4 4" />
              <motion.path 
                 d="M 0,50 L 200,50" 
                 fill="none" 
                 stroke="#3b82f6" 
        ...
        {/* Method Node */}
        <motion.div 
           animate={{ scale: called ? [1, 1.1, 1] : 1, borderColor: called ? "rgba(59,130,246,0.8)" : "var(--hairline)" }}
        ...
        >
           <div className="bg-surface-2 py-2 border-b border-hairline flex justify-center items-center">
             <span className="font-mono text-sm text-foreground font-semibold">display_details(<span className="text-blue-500">self</span>)</span>
           </div>
           <div className="p-4 flex flex-col items-center gap-2">
             <span className="text-[10px] text-muted-foreground font-mono uppercase tracking-widest">Output:</span>
             <motion.div 
                initial={{ opacity: 0 }} animate={{ opacity: called ? 1 : 0 }} transition={{ delay: 1 }}
...
function Step2ClassMethod() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-8 text-center">Uses <code className="text-emerald-500">cls</code> to modify class-level data shared by all objects.</p>
      
      <div className="relative font-mono text-sm bg-surface border border-hairline rounded-lg px-4 py-3 mb-6 shadow-sm w-[400px]">
        <div className="text-muted-foreground mb-2"># Calling the method</div>
        <span className="text-emerald-500 font-bold">Product</span>.<span className="text-amber-500">update_tax_rate</span>(0.09)
      </div>
      ...
      <div className="relative flex flex-col items-center w-full">
        ...
        >
           <span className="text-[10px] text-emerald-500 font-bold uppercase tracking-widest">Shared Class Attribute</span>
        ...
        {/* Connectors */}
        <svg className="absolute top-10 left-0 w-full h-24 pointer-events-none opacity-50 z-0" viewBox="0 0 600 100">
           <path d="M300,10 Q200,50 200,100" fill="none" stroke="currentColor" strokeOpacity="0.2" strokeWidth="2" strokeDasharray="4 4" />
           <path d="M300,10 Q400,50 400,100" fill="none" stroke="currentColor" strokeOpacity="0.2" strokeWidth="2" strokeDasharray="4 4" />
           <motion.path d="M300,10 Q200,50 200,100" fill="none" stroke="#10b981" strokeWidth="2" strokeDasharray="4 4" initial={{ pathLength: 0 }} animate={{ pathLength: tax === "0.09" ? 1 : 0 }} transition={{ duration: 0.8 }} />
           <motion.path d="M300,10 Q400,50 400,100" fill="none" stroke="#10b981" strokeWidth="2" strokeDasharray="4 4" initial={{ pathLength: 0 }} animate={{ pathLength: tax === "0.09" ? 1 : 0 }} transition={{ duration: 0.8 }} />
        </svg>

        {/* Instances Reacting */}
        <div className="flex gap-20 mt-16 relative z-10 w-full justify-center">
          {['laptop', 'headphones'].map((item) => (
            <div key={item} className="w-44 bg-surface border border-hairline rounded-xl overflow-hidden shadow-sm">
               <div className="bg-surface-2 py-1.5 border-b border-hairline flex justify-center items-center gap-2">
                 <span className="font-mono text-[11px] text-muted-foreground font-semibold">{item}</span>
               </div>
               <div className="p-3">
                 <div className="text-[10px] text-muted-foreground font-mono text-center mb-1">uses tax_rate:</div>
                 <motion.div 
                   key={tax}
...
function Step3StaticMethod() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-8 text-center">Does not use <code className="text-blue-500">self</code> or <code className="text-emerald-500">cls</code>. Independent utility.</p>
      
      <div className="relative font-mono text-sm bg-surface border border-hairline rounded-lg px-4 py-3 mb-10 shadow-sm w-[400px]">
        <div className="text-muted-foreground mb-2"># Calling the method</div>
        <span className="text-foreground font-bold">Product</span>.<span className="text-amber-500">is_valid_price</span>(<span className="text-violet-500">100</span>)
      </div>
      ...
      <div className="flex justify-between items-center w-full max-w-2xl relative z-10 px-10">
        ...
        <div className="w-24 flex justify-center">
           <div className="bg-surface-2 border border-violet-500/30 rounded-xl p-4 shadow-sm relative">
             ...
             <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-surface text-[9px] text-muted-foreground uppercase tracking-widest px-1">Value</span>
           </div>
        </div>
        ...
        {/* Method Node */}
        <motion.div 
           animate={{ scale: called ? [1, 1.1, 1] : 1, borderColor: called ? "rgba(139,92,246,0.8)" : "var(--hairline)" }}
           transition={{ delay: 0.8, duration: 0.3 }}
        ...
        >
           <div className="bg-violet-500/10 py-2 border-b border-violet-500/30 flex justify-center items-center">
             <span className="font-mono text-sm text-foreground font-semibold">is_valid_price(<span className="text-violet-500">price</span>)</span>
           </div>
           <div className="p-4 flex flex-col items-center gap-2 bg-surface">
             <span className="text-[10px] text-muted-foreground font-mono uppercase tracking-widest">Return:</span>
             <motion.div 
                initial={{ opacity: 0 }} animate={{ opacity: called ? 1 : 0 }} transition={{ delay: 1 }}
...
function Step4DecisionFlowchart() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-3 text-center">Follow the questions to choose the right method type.</p>
      ...
      <div className="w-full overflow-x-auto flex justify-center pb-2">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 720 290">
           ...
           <motion.path 
             ...
             fill="none" stroke="var(--hairline)" strokeWidth="2"
             initial={{ pathLength: 0 }} animate={{ pathLength: phase >= 1 ? 1 : 0 }} transition={{ duration: 0.8 }}
           />
           {/* Q1 to Q2 (No) */}
           <motion.path 
           ...
           <motion.path 
             ...
             fill="none" stroke="var(--hairline)" strokeWidth="2"
             initial={{ pathLength: 0 }} animate={{ pathLength: phase >= 2 ? 1 : 0 }} transition={{ duration: 0.8 }}
           />
           {/* Q2 to Static (No) */}
           <motion.path 
        ...
        <AnimatePresence>
           {phase >= 1 && (
             <>
               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute text-xs font-bold text-blue-500 z-10 bg-transparent" style={{ left: 195, top: 74 }}>Yes</motion.div>
               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute text-xs font-bold text-muted-foreground z-10 bg-transparent" style={{ left: 382, top: 74 }}>No</motion.div>
             </>
           )}
           {phase >= 2 && (
             <>
               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute text-xs font-bold text-emerald-500 z-10 bg-transparent" style={{ left: 405, top: 164 }}>Yes</motion.div>
               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="absolute text-xs font-bold text-muted-foreground z-10 bg-transparent" style={{ left: 532, top: 164 }}>No</motion.div>
             </>
           )}
        </AnimatePresence>

        {/* Q1: Need object data? */}
        <div className="absolute flex justify-center w-56 z-20" style={{ left: 300 - 112, top: 0 }}>
           <div className="bg-surface-2 px-3 py-2 rounded-lg font-mono text-xs text-foreground border border-hairline text-center shadow-sm w-full">
             Access specific object state? <br/> <span className="text-[10px] text-muted-foreground">e.g., read or modify <code className="text-blue-500">self.price</code></span>
           </div>
        </div>
          ...
          {phase >= 1 && (
            ...
            >
               <div className="bg-blue-500/10 border-2 border-blue-500/50 rounded-lg p-2.5 w-full text-center shadow-sm">
                  <div className="font-bold text-blue-500 text-[11px] uppercase tracking-wider mb-0.5">Instance</div>
                  <div className="font-mono text-xs text-foreground">self</div>
                  <div className="font-mono text-[9px] text-muted-foreground border-t border-blue-500/20 pt-1 mt-1.5">def get_price(self):</div>
               </div>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <AnimatePresence>
          {phase >= 1 && (
            ...
            >
               <div className="bg-surface-2 px-3 py-2 rounded-lg font-mono text-xs text-foreground border border-hairline text-center shadow-sm w-full">
                 Access shared class state? <br/> <span className="text-[10px] text-muted-foreground">e.g., read or modify <code className="text-emerald-500">cls.tax</code></span>
               </div>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          {phase >= 2 && (
            ...
            >
               <div className="bg-emerald-500/10 border-2 border-emerald-500/50 rounded-lg p-2.5 w-full text-center shadow-sm">
                  <div className="font-bold text-emerald-500 text-[11px] uppercase tracking-wider mb-0.5">Class</div>
                  <div className="font-mono text-xs text-foreground">cls</div>
                  <div className="font-mono text-[9px] text-muted-foreground border-t border-emerald-500/20 pt-1 mt-1.5">def set_tax(cls):</div>
               </div>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          {phase >= 2 && (
            ...
            >
               <div className="bg-violet-500/10 border-2 border-violet-500/50 rounded-lg p-2.5 w-full text-center shadow-sm">
                  <div className="font-bold text-violet-500 text-[11px] uppercase tracking-wider mb-0.5">Static</div>
                  <div className="font-mono text-xs text-muted-foreground italic">none</div>
                  <div className="font-mono text-[9px] text-muted-foreground border-t border-violet-500/20 pt-1 mt-1.5">def is_valid(p):</div>
               </div>
            </motion.div>
          )}
        </AnimatePresence>
