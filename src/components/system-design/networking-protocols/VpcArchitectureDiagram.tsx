      ...
      <div className="overflow-x-auto p-4 sm:p-8 flex justify-center bg-slate-50/30 dark:bg-slate-900/10">
        <div className="relative w-[800px] h-[420px] min-w-[800px] text-sm">
          ...
          <svg className="absolute inset-0 z-10" width="800" height="420">
            ...
            {/* App to NAT */}
            <path
              d="M 460 195 L 400 195 L 400 310 L 340 310"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              strokeDasharray="4 4"
            ...
            {/* NAT to IGW */}
            <path
              d="M 220 285 L 220 240 L 400 240 L 400 108"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
              strokeDasharray="4 4"
          ...
          {/* 1. Internet Node */}
          <div
            className="absolute flex flex-col items-center justify-center gap-1.5 z-20 text-blue-600 dark:text-blue-400 font-medium bg-slate-50/30 dark:bg-slate-900/10 px-4 py-2"
            style={{ left: 320, top: 0, width: 160, height: 60 }}
          >
          ...
          {/* 2. Region Box */}
          <div
            className="absolute rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/30 p-4 z-0"
            style={{ left: 20, top: 50, width: 760, height: 350 }}
          >
          ...
          {/* 3. VPC Box */}
          <div
            className="absolute rounded-xl border border-emerald-300 bg-emerald-50/30 dark:bg-emerald-950/20 z-0"
            style={{ left: 40, top: 90, width: 720, height: 290 }}
          >
          ...
          {/* 4. IGW Node */}
          <div
            className="absolute flex items-center justify-center gap-2 rounded-lg border border-purple-300 bg-purple-100 px-4 text-purple-700 shadow-sm z-20 dark:border-purple-700/50 dark:bg-purple-900/80 dark:text-purple-300"
            style={{ left: 310, top: 72, width: 180, height: 36 }}
          >
          ...
          {/* 5. Public Subnet Box */}
          <div
            className="absolute rounded-xl border border-blue-300 bg-blue-50/50 dark:bg-blue-950/30 z-0"
            style={{ left: 60, top: 130, width: 320, height: 230 }}
          >
          ...
          <div
            className="absolute rounded-xl border border-slate-300 bg-slate-100/50 dark:bg-slate-800/50 z-0"
            style={{ left: 420, top: 130, width: 320, height: 230 }}
          >
          ...
          {/* Load Balancer */}
          <div
            className="absolute flex flex-col justify-center rounded border border-blue-200 bg-white px-3 shadow-sm z-20 dark:border-blue-800 dark:bg-slate-800"
            style={{ left: 100, top: 155, width: 240, height: 50 }}
          >
          ...
          <div
            className="absolute flex flex-col justify-center rounded border border-blue-200 bg-white px-3 shadow-sm z-20 dark:border-blue-800 dark:bg-slate-800"
            style={{ left: 100, top: 285, width: 240, height: 50 }}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
          ...
          {/* App Server */}
          <div
            className="absolute flex flex-col justify-center rounded border border-slate-200 bg-white px-3 shadow-sm z-20 dark:border-slate-700 dark:bg-slate-900"
            style={{ left: 460, top: 155, width: 240, height: 50 }}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
          ...
          <div
            className="absolute flex flex-col justify-center rounded border border-slate-200 bg-white px-3 shadow-sm z-20 dark:border-slate-700 dark:bg-slate-900"
            style={{ left: 460, top: 285, width: 240, height: 50 }}
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300">
