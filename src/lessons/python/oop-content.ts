      ...
      lessons: [
        {
          ...
          subtitle:
            "Learn how Python classes and objects help you organize related data and behavior into reusable code.",
          sections: [
            {
              kind: "prose",
            ...
            },
            {
              ...
              body: ["### 1. Create a class", "Use the `class` keyword to define a class."],
            },
            {
              ...
              questions: [
                {
                  ...
                  correctIndex: 1,
                  explanation:
                    "A class acts as a blueprint or template. It defines the structure (attributes) and behavior (methods) that all objects created from it will have.",
                },
                {
                  id: "oop-basics-2",
                  ...
                  correctIndex: 1,
                  explanation:
                    "The `__init__()` method is called automatically when an object is instantiated. It is used to initialize the object's starting attributes.",
                },
                {
                  id: "oop-basics-3",
                  question:
                    "In the method definition `def drive(self):`, what does `self` refer to?",
                  options: [
                    "The class itself",
                    "The `drive` function",
                  ...
                  correctIndex: 2,
                  explanation:
                    "`self` is a reference to the current instance of the class. It allows the object to access its own attributes and other methods.",
                },
                {
                  id: "oop-basics-4",
                  question:
                    "Write the code to create a `BankAccount` class with an `__init__` method that accepts `owner` and `balance` parameters and assigns them to instance attributes.",
                  interactiveCode: true,
                  initialCode: "# Write your class here:\n\n",
                  testCode: "acc = BankAccount('Alice', 100)\nprint(acc.owner)\nprint(acc.balance)",
                  expectedOutput: "Alice\n100",
                  explanation:
                    "`self` correctly references the instance, and assigning `self.owner` and `self.balance` ensures those values belong to each specific `BankAccount` instance.",
                },
                {
                  id: "oop-basics-5",
                  question:
                    "If we define a class `Car` and create two objects `car1 = Car()` and `car2 = Car()`, which of the following is true?",
                  options: [
                  ...
                  correctIndex: 1,
                  explanation:
                    "Classes act as blueprints. You can instantiate as many objects as you want from a single class, and each object will be a completely independent instance.",
                },
              ],
            },
          ],
        },
        {
          ...
          subtitle:
            "Learn when data should belong to one object and when it should be shared by every object in a class.",
          sections: [
            {
              kind: "prose",
              heading: "Why this matters",
              ...
              questions: [
                {
                  id: "attr-vs-class-1",
                  question:
                    "Is `student_name` more likely to be an instance attribute or a class attribute?",
                  options: ["Instance attribute", "Class attribute"],
                  correctIndex: 0,
                  explanation:
                    "Every student has their own unique name, so it belongs to the individual object.",
                },
                {
                  id: "attr-vs-class-2",
                  question:
                    "Should a shared `school_name` normally be an instance attribute or a class attribute?",
                  options: ["Instance attribute", "Class attribute"],
                  correctIndex: 1,
                  explanation:
                    "Since the school name is shared across all students, it makes sense to store it once as a class attribute.",
                },
                {
                  id: "attr-vs-class-3",
                  question:
                    "In a class `Car` with `wheels = 4` and `self.brand = brand`, which attribute is shared across all cars?",
                  options: ["brand", "wheels", "Both of them", "Neither of them"],
                  correctIndex: 1,
                  explanation:
                    "`wheels` is defined at the class level, making it a class attribute shared by all cars. `brand` is defined on `self`, meaning it's an instance attribute.",
                },
                {
                  id: "attr-vs-class-4",
                  question:
                    'Write the code to create a `Dog` class with a class attribute `species` set to `"Canis"`, and an `__init__` method that assigns an instance attribute `name`.',
                  interactiveCode: true,
                  initialCode: "# Write your class here:\n\n",
                  testCode: "dog = Dog('Buddy')\nprint(Dog.species)\nprint(dog.name)",
                  expectedOutput: "Canis\nBuddy",
                  explanation:
                    "`species` should be defined directly inside the class, while `self.name` is assigned inside the `__init__` method.",
                },
                {
                  id: "attr-vs-class-5",
                  question:
                    "If you change a class attribute directly on the class (e.g., `Car.wheels = 3`), what happens?",
                  options: [
                  ...
                  correctIndex: 1,
                  explanation:
                    "Class attributes are shared by reference. Changing the value on the class itself updates it for all instances that share that attribute.",
                },
              ],
            },
          ],
              ...
              questions: [
                {
                  id: "types-methods-1",
                  question:
                    "Which method type should you use to update one customer's account balance?",
                  options: ["Instance method", "Class method", "Static method"],
                  correctIndex: 0,
                  explanation:
                    "Updating one customer's account requires object-specific data, so you should use an instance method.",
                },
                {
                  id: "types-methods-2",
                  question:
                    "Which method type should you use to change a shared interest rate for all accounts?",
                  options: ["Instance method", "Class method", "Static method"],
                  correctIndex: 1,
                  explanation:
                    "Changing a shared value (like a global interest rate) affects the class as a whole, which is what a class method is for.",
                },
                {
                  id: "types-methods-3",
                  question:
                    "Which method type could check whether an account number has the correct length without accessing any object data?",
                  options: ["Instance method", "Class method", "Static method"],
                  correctIndex: 2,
                  explanation:
                    "If it doesn't need to read any object or class data, and just validates an input, it should be a static method.",
                },
                {
                  id: "types-methods-4",
                  ...
                  correctIndex: 1,
                  explanation:
                    "`self` provides access to the current instance (object), whereas `cls` provides access to the class itself.",
                },
                {
                  id: "types-methods-5",
                  question:
                    "Complete the `User` class by defining an instance method `get_email`, a class method `get_company`, and a static method `is_valid_email`.",
                  interactiveCode: true,
                  initialCode:
                  ...
                  explanation:
                    "An instance method uses `self`, a class method uses `@classmethod` and `cls`, and a static method uses `@staticmethod` and just the argument.",
                },
              ],
            },
          ],
              ...
              questions: [
                {
                  ...
                  correctIndex: 1,
                  explanation:
                    "Encapsulation groups data and behavior together, allowing you to define rules for how that data can be accessed or changed.",
                },
                {
                  id: "encapsulation-2",
                  ...
                  correctIndex: 1,
                  explanation:
                    "Python does not strictly enforce private attributes. The leading underscore is a convention used by programmers.",
                },
                {
                  id: "encapsulation-3",
                  ...
                  correctIndex: 2,
                  explanation:
                    '`@property` turns a method into a "getter", so you can call `obj.value` instead of `obj.value()`.',
                },
                {
                  id: "encapsulation-4",
                  question:
                    "Why is it generally better to put validation inside a property setter instead of checking values before assignment in outside code?",
                  options: [
                  ...
                  correctIndex: 1,
                  explanation:
                    "Centralizing logic inside the class (encapsulation) prevents duplicate code and ensures rules are consistently applied everywhere.",
                },
                {
                  id: "encapsulation-5",
                  question:
                    "Add validation so the following `Person` class does not allow a negative age. Create a property `age` and a setter that assigns the value if it's `>= 0`, or prints 'Invalid age' if negative.",
                  interactiveCode: true,
                  initialCode:
                  ...
                  expectedOutput: "25\n30\nInvalid age\n30",
                  explanation:
                    "The `@property` defines the getter, and `@age.setter` defines the setter where you perform the validation check before modifying `self._age`.",
                },
              ],
            },
          ],
              ...
              questions: [
                {
                  ...
                  correctIndex: 2,
                  explanation:
                    "Single inheritance is a straightforward 1-to-1 relationship from parent to child.",
                },
                {
                  id: "inheritance-2",
                  ...
                  correctIndex: 1,
                  explanation:
                    "Multiple inheritance is parallel (combining traits), while multilevel is vertical (deepening traits).",
                },
                {
                  id: "inheritance-3",
                  ...
                  correctIndex: 1,
                  explanation:
                    "`super()` delegates method calls back to the parent class. Using it in `__init__` ensures the parent's setup logic runs.",
                },
                {
                  id: "inheritance-4",
                  question:
                    'Create a `Vehicle` class with a `move()` method that prints "Vehicle is moving.". Then create a `Bike` class that inherits from `Vehicle` and adds a `ring_bell()` method that prints "Ring ring!".',
                  interactiveCode: true,
                  initialCode:
                  ...
                  explanation:
                    "`Bike` can use the `move()` method it inherits from `Vehicle`, and it also has its own `ring_bell()` method.",
                },
                {
                  id: "inheritance-5",
                  question:
                    'Create a `Flyer` class with a `fly()` method that prints "Flying.". Create a `Swimmer` class with a `swim()` method that prints "Swimming.". Then create a `Duck` class that inherits from both.',
                  interactiveCode: true,
                  initialCode:
                    "# 1. Create Flyer and Swimmer classes\n\n\n\n\n# 2. Create Duck class (multiple inheritance)\n\n\n",
                  testCode: "duck = Duck()\nduck.fly()\nduck.swim()",
                  expectedOutput: "Flying.\nSwimming.",
                  explanation:
                    "This is an example of Multiple Inheritance where `Duck(Flyer, Swimmer)` gets capabilities from both.",
                },
              ],
            },
          ],
              ...
              questions: [
                {
                  ...
                  correctIndex: 2,
                  explanation:
                    "The `+` operator has polymorphic behavior, mapping to numeric addition for ints and string concatenation for strings.",
                },
                {
                  id: "poly-2",
                  ...
                  correctIndex: 1,
                  explanation:
                    "Python calls the `__add__()` method when the `+` operator is used on an object.",
                },
                {
                  id: "poly-3",
                  ...
                  correctIndex: 3,
                  explanation:
                    "`len()` can count characters in a string, items in a list, or keys in a dictionary.",
                },
                {
                  id: "poly-4",
                  question:
                    "Do two classes always need the same parent class to behave polymorphically?",
                  options: [
                  ...
                  correctIndex: 1,
                  explanation:
                    "Duck typing allows Python to focus on whether an object has the right methods, regardless of its inheritance.",
                },
                {
                  id: "poly-tiny-task",
                  question:
                    "Create two classes, `PDFReport` and `CSVReport`. Both should provide an `export()` method. Then create a function `export_report(report)` that calls `export()` on any report passed to it.",
                  interactiveCode: true,
                  ...
                  explanation:
                    "Both classes implement `export()`, allowing `export_report` to treat them polymorphically.",
                },
                {
                  id: "poly-bonus-task",
                  question:
                    "Create a `Money` class that takes an `amount` in `__init__`. Define `__add__()` so two `Money` objects can be added, returning a new `Money` object with the total amount. Print the final amount.",
                  interactiveCode: true,
                  initialCode: "# Create your Money class here:\n\n",
                  testCode: "m1 = Money(100)\nm2 = Money(50)\ntotal = m1 + m2\nprint(total.amount)",
                  expectedOutput: "150",
                  explanation:
                    "By defining `__add__(self, other)`, you taught Python how to combine two Money objects using the `+` operator.",
                },
              ],
            },
            {
        ...
        },
        {
          ...
          title: "Abstraction",
          subtitle:
            "Learn how abstraction lets you define what a class must do while hiding the implementation details behind a simple interface.",
          sections: [
            {
              kind: "prose",
              heading: "Why this matters",
            ...
            {
              kind: "prose",
              body: ["If a child forgets to implement `pay()`:"],
            },
            {
              kind: "interactive-code",
            ...
            {
              kind: "prose",
              body: ["The existing `export_report()` function does not need to change."],
            },
            {
              kind: "callout",
              tone: "warn",
              ...
              questions: [
                {
                  ...
                  correctIndex: 0,
                  explanation:
                    "Abstraction simplifies interaction by exposing a simple interface and hiding the complex implementation details.",
                },
                {
                  id: "q2",
                  ...
                  correctIndex: 1,
                  explanation:
                    "ABC stands for Abstract Base Class, which is provided by the `abc` module.",
                },
                {
                  id: "q3",
                  ...
                  correctIndex: 1,
                  explanation:
                    "It enforces a contract by requiring child classes to provide their own implementation for the method.",
                },
                {
                  id: "q4",
                  ...
                  correctIndex: 0,
                  explanation:
                    "Abstract classes can mix both abstract methods (required) and concrete methods (shared behavior).",
                },
                {
                  id: "q5",
                  interactiveCode: true,
                  question:
                    "Create an abstract `Notification` class with a required `send(message)` method. Then create `EmailNotification` and `SMSNotification` classes that implement `send()`.",
                  initialCode:
                  ...
                  expectedOutput:
                    "Success! You implemented the abstract base class and concrete classes correctly.",
                },
              ],
            },
          ],
        },
        {
          ...
          title: "Composition",
          subtitle:
            "Learn how to build larger Python objects by combining smaller objects instead of forcing everything into an inheritance hierarchy.",
          sections: [
            {
              kind: "prose",
              heading: "Why this matters",
            ...
            },
            {
              ...
              body: ["Start with a class that handles one responsibility."],
            },
            {
              kind: "interactive-code",
            ...
            {
              kind: "prose",
              body: ["The `Car` behavior changes based on the component it receives."],
            },
            {
              kind: "prose",
            ...
            {
              kind: "prose",
              body: ["Now compose an `Order` using a `ShoppingCart`."],
            },
            {
              kind: "interactive-code",
              ...
              questions: [
                {
                  ...
                  correctIndex: 1,
                  explanation:
                    'Composition typically models a "has-a" relationship, like a Car has an Engine.',
                },
                {
                  id: "c2",
                  ...
                  correctIndex: 2,
                  explanation:
                    'Inheritance represents "is-a". Since a Car is not an Engine, composition is the correct modeling choice.',
                },
                {
                  id: "c3",
                  ...
                  correctIndex: 3,
                  explanation:
                    "Delegation is when a method on the main object calls a method on its component to perform the actual work (e.g. car.start() calling self.engine.start()).",
                },
                {
                  id: "c4",
                  ...
                  correctIndex: 1,
                  explanation:
                    'While both model "has-a", aggregation implies a looser relationship where the component object has its own independent lifecycle.',
                },
                {
                  id: "c5",
                  interactiveCode: true,
                  question:
                    "Create a `Battery` class with a `charge()` method. Then create a `Laptop` class that is passed a battery object in its `__init__`, and has a `charge()` method that delegates to the battery.",
                  initialCode:
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              body: ["You have already used the most familiar special method:"],
            },
            {
              kind: "interactive-code",
              ...
              questions: [
                {
                  ...
                  correctIndex: 0,
                  explanation:
                    "Python's `len()` function automatically delegates to the `__len__()` special method.",
                },
                {
                  id: "q2",
                  ...
                  correctIndex: 0,
                  explanation:
                    "`__str__()` provides a readable representation (used by `print()`), whereas `__repr__()` provides a detailed, unambiguous representation meant for developers.",
                },
                {
                  id: "q3",
                  question: "Which method can define the behavior of `object1 + object2`?",
                  options: ["__add__()", "__plus__()", "__sum__()", "__append__()"],
                  correctIndex: 0,
