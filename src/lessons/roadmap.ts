...
export const roadmap: RoadmapCategory[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      lockedPattern("The Scrapy Framework", "scrapy-framework", "Build high-performance, asynchronous web crawling spiders that scale."),
      lockedPattern("Scale & Politeness", "scale-and-politeness", "Manage rate limits, handle retries, rotate proxies, and respect robots.txt."),
      lockedPattern("APIs & Alternatives", "apis-and-alternatives", "Why scrape when you don't have to? Finding official APIs and hidden endpoints."),
      lockedPattern("AI Browser Agents", "ai-agents", "Use LLMs and vision models to navigate pages and extract unstructured data automatically."),
    ],
  },
  {
    title: "Docker",
