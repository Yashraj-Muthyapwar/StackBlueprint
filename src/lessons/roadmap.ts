            ...
            lessons: [
              {
                ...
                slug: "inner-outer",
                path: "/sql/querying/joins/inner-outer",
                icon: GitMerge,
              },
              {
                title: "Self Joins",
                slug: "self-joins",
                path: "/sql/querying/joins/self-joins",
                icon: GitMerge,
              },
              {
                title: "Filtering Joins (Semi & Anti)",
                slug: "semi-anti",
                path: "/sql/querying/joins/semi-anti",
                icon: GitMerge,
              },
              {
                title: "Under-the-Hood Join Algorithms",
                slug: "join-algorithms",
                path: "/sql/querying/joins/join-algorithms",
                icon: Workflow,
              },
              {
                title: "Joins: Final Quiz",
                slug: "joins-quiz",
                path: "/sql/querying/joins/joins-quiz",
                icon: HelpCircle,
              },
            ],
          },
