        ...
        patterns: [
          {
            ...
            blurb: "Databases, DBMSs, relational modeling, keys, SQL command families, and storage basics.",
            lessons: [
              { title: "What is a Database?", slug: "what-is-database", path: "/sql/foundations/database-fundamentals/what-is-database", icon: Database },
              { title: "What is a DBMS?", slug: "what-is-a-dbms", path: "/sql/foundations/database-fundamentals/what-is-a-dbms", icon: Database },
              { title: "The Relational Model", slug: "relational-model-basics", path: "/sql/foundations/database-fundamentals/relational-model-basics", icon: Table },
              { title: "Keys in Relational Databases", slug: "keys-in-relational-databases", path: "/sql/foundations/database-fundamentals/keys-in-relational-databases", icon: KeyRound },
              { title: "Levels of Abstraction", slug: "levels-of-abstraction", path: "/sql/foundations/database-fundamentals/levels-of-abstraction", icon: Layers },
              { title: "SQL Command Families", slug: "sql-commands", path: "/sql/foundations/database-fundamentals/sql-commands", icon: Terminal },
              { title: "The Database Landscape", slug: "database-landscape", path: "/sql/foundations/database-fundamentals/database-landscape", icon: Boxes },
              { title: "How Databases Work Under the Hood", slug: "db-under-the-hood", path: "/sql/foundations/database-fundamentals/db-under-the-hood", icon: Database },
              { title: "Database Fundamentals: Final Quiz", slug: "fundamentals-quiz", path: "/sql/foundations/database-fundamentals/fundamentals-quiz", icon: HelpCircle },
            ],
          },
          {
            ...
            blurb: "Choose types for numeric, text, date, JSON, and missing values without losing meaning.",
            lessons: [
              { title: "Numeric & Text Types", slug: "numeric-text", path: "/sql/foundations/data-types/numeric-text", icon: Hash },
              { title: "Dates, Timestamps & Time Zones", slug: "dates-timestamps", path: "/sql/foundations/data-types/dates-timestamps", icon: Calendar },
              { title: "JSON & JSONB", slug: "json-jsonb", path: "/sql/foundations/data-types/json-jsonb", icon: Braces },
              { title: "NULL Semantics", slug: "null-semantics", path: "/sql/foundations/data-types/null-semantics", icon: AlertTriangle },
            ],
          },
          {
            ...
            blurb: "SELECT, FROM, filters, ordering, operators, and the logical order that makes queries predictable.",
            lessons: [
              { title: "Your First Query", slug: "your-first-query", path: "/sql/foundations/sql-querying-fundamentals/your-first-query", icon: Table },
        ...
        patterns: [
          {
            ...
            lessons: [
              { title: "Boolean Logic (AND / OR / NOT)", slug: "boolean-logic", path: "/sql/querying/filtering/boolean-logic", icon: Filter },
              { title: "Set, Range & Array Filtering", slug: "in-between", path: "/sql/querying/filtering/in-between", icon: Filter },
              { title: "Pattern Matching (LIKE / ILIKE)", slug: "like-ilike", path: "/sql/querying/filtering/like-ilike", icon: Filter },
              { title: "The NULL Pitfalls (Three-Valued Logic)", slug: "null-pitfalls", path: "/sql/querying/filtering/null-pitfalls", icon: AlertTriangle },
              { title: "Writing Efficient WHERE Predicates", slug: "writing-efficient-where-predicates", path: "/sql/querying/filtering/writing-efficient-where-predicates", icon: Search },
              { title: "Filtering & Predicates: Final Quiz", slug: "filtering-predicates-quiz", path: "/sql/querying/filtering/filtering-predicates-quiz", icon: HelpCircle },
            ],
          },
          {
          ...
          },
          {
            ...
            blurb: "Combine related tables, choose join shapes, and understand how the database executes them.",
            lessons: [
              { title: "Core Shapes (INNER vs LEFT / RIGHT / FULL)", slug: "inner-outer", path: "/sql/querying/joins/inner-outer", icon: GitMerge },
              { title: "Self Joins", slug: "self-joins", path: "/sql/querying/joins/self-joins", icon: GitMerge },
              { title: "Filtering Joins (Semi & Anti)", slug: "semi-anti", path: "/sql/querying/joins/semi-anti", icon: GitMerge },
              { title: "Under-the-Hood Join Algorithms", slug: "join-algorithms", path: "/sql/querying/joins/join-algorithms", icon: Workflow },
              { title: "Joins: Final Quiz", slug: "joins-quiz", path: "/sql/querying/joins/joins-quiz", icon: HelpCircle },
            ],
          },
          {
            ...
            blurb: "Use scalar and correlated subqueries, existence checks, and set operations with confidence.",
            lessons: [
              { title: "Scalar Subqueries", slug: "scalar-subqueries", path: "/sql/querying/subqueries/scalar-subqueries", icon: Layers },
              { title: "Correlated Subqueries", slug: "correlated-subqueries", path: "/sql/querying/subqueries/correlated-subqueries", icon: Layers },
        ...
        patterns: [
          {
            ...
            lessons: [
              ...
              { title: "UPPER / LOWER: Standardize Text", slug: "upper-lower", path: "/sql/specialized/string-functions/upper-lower", icon: Hash },
              { title: "TRIM / REPLACE: Clean Text", slug: "trim-replace", path: "/sql/specialized/string-functions/trim-replace", icon: Hash },
              { title: "POSITION / SPLIT_PART", slug: "position-split-part", path: "/sql/specialized/string-functions/position-split-part", icon: Hash },
              { title: "Regular Expressions: Flexible Pattern Matching", slug: "regex", path: "/sql/specialized/string-functions/regex", icon: Hash },
              { title: "String Functions: Final Quiz", slug: "string-functions-quiz", path: "/sql/specialized/string-functions/string-functions-quiz", icon: HelpCircle },
            ],
          },
          {
            title: "Conversions",
            ...
            lessons: [
              { title: "CAST / TO_CHAR (Type Casting)", slug: "cast-to-char", path: "/sql/specialized/conversions/cast-to-char", icon: Repeat },
              { title: "CONVERT", slug: "convert", path: "/sql/specialized/conversions/convert", icon: Repeat },
              { title: "Implicit Coercion", slug: "implicit-coercion", path: "/sql/specialized/conversions/implicit-coercion", icon: Repeat },
              { title: "Safe Casts", slug: "safe-casts", path: "/sql/specialized/conversions/safe-casts", icon: Repeat },
            ],
          },
        ],
      },
