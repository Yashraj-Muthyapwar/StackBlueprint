      ...
      },
      {
        ...
        patterns: [
          ...
          },
          {
            ...
            lessons: [
              { title: "2.1 Aggregate Functions (COUNT / SUM / AVG / MIN / MAX)", slug: "aggregate-functions", path: "/sql/querying/aggregations/aggregate-functions", icon: Sigma },
              { title: "2.2 The Collapse Engine (GROUP BY)", slug: "group-by", path: "/sql/querying/aggregations/group-by", icon: Sigma },
              { title: "2.3 Evaluation Filtering (HAVING)", slug: "having", path: "/sql/querying/aggregations/having", icon: Filter },
              { title: "2.4 Multi-Dimensional Aggregations (GROUPING SETS / ROLLUP / CUBE)", slug: "grouping-sets", path: "/sql/querying/aggregations/grouping-sets", icon: Sigma },
            ],
          },
          {
            title: "03 · Joins",
            ...
            lessons: [
              { title: "3.1 Core Shapes (INNER vs LEFT / RIGHT / FULL)", slug: "inner-outer", path: "/sql/querying/joins/inner-outer", icon: GitMerge },
              { title: "3.2 Self Joins", slug: "self-joins", path: "/sql/querying/joins/self-joins", icon: GitMerge },
              { title: "3.3 Filtering Joins (Semi & Anti)", slug: "semi-anti", path: "/sql/querying/joins/semi-anti", icon: GitMerge },
              { title: "3.4 Under-the-Hood Join Algorithms", slug: "join-algorithms", path: "/sql/querying/joins/join-algorithms", icon: Workflow },
            ],
          },
          {
            ...
            lessons: [
              { title: "4.1 Scalar Subqueries", slug: "scalar-subqueries", path: "/sql/querying/subqueries/scalar-subqueries", icon: Layers },
              { title: "4.2 Correlated Subqueries", slug: "correlated-subqueries", path: "/sql/querying/subqueries/correlated-subqueries", icon: Layers },
              { title: "4.3 Existence Checks (EXISTS vs IN)", slug: "exists-vs-in", path: "/sql/querying/subqueries/exists-vs-in", icon: Filter },
              { title: "4.4 Set Operations (UNION / INTERSECT / EXCEPT)", slug: "set-ops", path: "/sql/querying/subqueries/set-ops", icon: Layers },
            ],
          },
        ],
      },
