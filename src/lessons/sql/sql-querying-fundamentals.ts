  ...
  sections: [
    {
      ...
      questions: [
        ...
        {
          id: "qf-comments",
          question: "Which text starts a single-line SQL comment?",
          options: ["//", "--", "##", "/* only"],
          correctIndex: 1,
          explanation: "Two hyphens begin a comment that runs to the end of the line.",
        },
        {
          id: "qf-calculation-alias",
          question: "What does AS price_with_tax do in SELECT price * 1.08 AS price_with_tax?",
          options: [
            "Filters products that have tax.",
            "Names the calculated result column price_with_tax.",
            "Changes every stored price permanently.",
            "Sorts prices from highest to lowest.",
          ],
          correctIndex: 1,
        ...
        {
          id: "qf-arithmetic",
          question: "Which expression calculates a product's gross margin from price and cost?",
          options: ["price + cost", "price - cost", "price = cost", "price AND cost"],
          correctIndex: 1,
          explanation: "Subtracting cost from price produces the gross margin for that row.",
        },
        {
          id: "qf-boolean",
          ...
          correctIndex: 1,
          explanation: "Both requirements must be true for the same product, so use AND.",
        },
        {
          id: "qf-where-null",
        ...
        {
          id: "qf-distinct",
          question: "What does SELECT DISTINCT country FROM customers return?",
          options: [
            "Every customer row, sorted by country",
            "One row for each different country value",
            "Only countries with exactly one customer",
            "The first country only",
          ],
          correctIndex: 1,
          explanation: "DISTINCT removes duplicate result rows, leaving each country value once.",
        },
        {
          id: "qf-order-limit",
          question: "How do you return the three most expensive products?",
          options: [
            "ORDER BY price ASC LIMIT 3",
            "ORDER BY price DESC LIMIT 3",
            "WHERE price DESC LIMIT 3",
            "DISTINCT price LIMIT 3",
          ],
          correctIndex: 1,
