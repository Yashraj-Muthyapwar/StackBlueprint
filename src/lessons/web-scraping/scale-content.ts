...
// ==========================================
const readingRobots: LessonContent = {
  slug: "reading-robots-txt",
  title: "Reading robots.txt Properly",
  subtitle: "parsing, crawl-delay, and what it does and does not mean",
  sections: [],
};
const rateLimiting: LessonContent = {
  slug: "rate-limiting-throttling",
  title: "Rate Limiting and Throttling",
  subtitle: "fixed delays, adaptive throttling, and concurrency caps",
  sections: [],
};
const retryStrategy: LessonContent = {
  slug: "retry-strategy",
  title: "Retry Strategy",
  subtitle: "exponential backoff, jitter, and which status codes to retry",
  sections: [],
};
const handlingBans: LessonContent = {
  slug: "handling-bans",
  title: "Handling Bans and Blocks",
  subtitle: "reading 403s and 429s, and backing off gracefully",
  sections: [],
};
const proxyRotation: LessonContent = {
  slug: "proxy-rotation",
  title: "Proxy Rotation",
  subtitle: "residential vs datacenter, rotation logic, and cost tradeoffs",
  sections: [],
};
const failingLoudly: LessonContent = {
  slug: "failing-loudly",
  title: "Failing Loudly",
  subtitle: "dead-letter queues and never silently dropping records",
  sections: [],
};
...
// ==========================================
const howDetectionWorks: LessonContent = {
  slug: "how-detection-works",
  title: "How Detection Works",
  subtitle: "TLS fingerprints, header order, and behavioral signals",
  sections: [],
};
const browserFingerprinting: LessonContent = {
  slug: "browser-fingerprinting",
  title: "Browser Fingerprinting",
  subtitle: "canvas, WebGL, and why headless leaks",
  sections: [],
};
const detectingCaptchas: LessonContent = {
  slug: "detecting-captchas",
  title: "Detecting Captchas and Walls",
  subtitle: "recognizing the signal and responding correctly",
  sections: [],
};
const knowingWhenToStop: LessonContent = {
  slug: "knowing-when-to-stop",
  title: "Knowing When to Stop",
  subtitle: "escalation as a red flag, not a challenge",
  sections: [],
};
...
// ==========================================
const publicVsProtected: LessonContent = {
  slug: "public-vs-protected-data",
  title: "Public Data vs Protected Data",
  subtitle: "the actual distinction courts care about",
  sections: [],
};
const tosAndCfaa: LessonContent = {
  slug: "tos-cfaa-hiq",
  title: "Terms of Service, CFAA, and hiQ v LinkedIn",
  subtitle: "understanding legal precedent",
  sections: [],
};
const personalData: LessonContent = {
  slug: "personal-data-gdpr",
  title: "Personal Data, GDPR, and CCPA",
  subtitle: "PII in scraped datasets",
  sections: [],
};
const copyrightDatabase: LessonContent = {
  slug: "copyright-database-rights",
  title: "Copyright and Database Rights",
  subtitle: "facts vs expression, and what you can republish",
  sections: [],
};
...
// ==========================================
const incrementalScraping: LessonContent = {
  slug: "incremental-scraping",
  title: "Incremental Scraping",
  subtitle: "change detection, ETags, and last-modified",
  sections: [],
};
const deduplication: LessonContent = {
  slug: "deduplication-scale",
  title: "Deduplication at Scale",
  subtitle: "URL normalization, hashing, and bloom filters",
  sections: [],
};
const scheduling: LessonContent = {
  slug: "scheduling",
  title: "Scheduling",
  subtitle: "cron, GitHub Actions, and Airflow for dependency-aware runs",
  sections: [],
};
const containerizing: LessonContent = {
  slug: "containerizing-scraper",
  title: "Containerizing a Scraper",
  subtitle: "Docker images with browser dependencies",
  sections: [],
};
const monitoringAlerting: LessonContent = {
  slug: "monitoring-alerting",
  title: "Monitoring and Alerting",
  subtitle: "success rates, volume anomalies, and silent failures",
  sections: [],
};
const handlingSchemaDrift: LessonContent = {
  slug: "handling-schema-drift",
  title: "Handling Schema Drift",
  subtitle: "detecting when the site changed before your data rots",
  sections: [],
};
...
// ==========================================
const llmExtraction: LessonContent = {
  slug: "llm-extraction",
  title: "LLM Extraction from HTML",
  subtitle: "structured output, JSON schemas, and validation",
  sections: [],
};
const domToMarkdown: LessonContent = {
  slug: "dom-to-markdown",
  title: "DOM to Markdown",
  subtitle: "preprocessing pages to cut token cost by 90 percent",
  sections: [],
};
const visionModels: LessonContent = {
  slug: "vision-models",
  title: "Vision Models for Layout",
  subtitle: "when screenshots beat HTML",
  sections: [],
};
const autoNavigating: LessonContent = {
  slug: "auto-navigating-agents",
  title: "Auto-Navigating Agents",
  subtitle: "goal-driven browsing and where it breaks",
  sections: [],
};
const costLatency: LessonContent = {
  slug: "cost-latency-determinism",
  title: "Cost, Latency, and Determinism",
  subtitle: "why LLM extraction is a fallback, not a default",
  sections: [],
};
...
// CHAPTER 14: Capstone
// ==========================================
const choosingTarget: LessonContent = {
  slug: "choosing-target",
  title: "Choosing a Target and Scoping the Dataset",
  subtitle: "",
  sections: [],
};
const buildingPipeline: LessonContent = {
  slug: "building-pipeline",
  title: "Building the Pipeline",
  subtitle: "discovery, fetch, parse, validate, store",
  sections: [],
};
const deployingScheduling: LessonContent = {
  slug: "deploying-scheduling",
  title: "Deploying and Scheduling It",
  subtitle: "",
  sections: [],
};
const publishingDataset: LessonContent = {
