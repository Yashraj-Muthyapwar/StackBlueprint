        ...
        <>
          <div className="mb-10 space-y-4">
            <p className="leading-relaxed text-muted-foreground lg:text-lg">
              The data engineering ecosystem is vast and constantly evolving. Every year, FirstMark
              Capital publishes the <strong>MAD (Machine Learning, AI, and Data) Landscape</strong>{" "}
              to map out the thousands of tools, frameworks, and companies that make up the modern
              data ecosystem.
            </p>
            <p className="leading-relaxed text-muted-foreground lg:text-lg">
              Explore the interactive map below to get a sense of how expansive the field has
              become. Don't worry if it feels overwhelming, throughout this track, we will focus on
              the fundamental concepts rather than trying to memorize every single tool.
            </p>
          </div>
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            ...
            >
              MAD (Machine Learning, AI, Data) Landscape
            </a>
            . All rights reserved by FirstMark.
          </p>
        </>
      ) : null}
    </LessonLayout>
