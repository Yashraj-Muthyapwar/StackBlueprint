...

  {
    ...
    topics: [
      ...
      },
      {
        ...
        icon: Calculator,
        modules: [
          "ROUND / TRUNC / CEIL / FLOOR: Shape Numbers",
          "NULLIF / COALESCE: Safe Math",
          "ABS / SIGN / LEAST / GREATEST: Compare Values",
          "MOD / %: Remainder & Parity",
          "POWER / SQRT / EXP / LOG: Model Scale",
          "RANDOM / RAND: Numbers in a Range",
          "Final quiz",
        ],
        unlocked: true,
        routeBase: "specialized",
