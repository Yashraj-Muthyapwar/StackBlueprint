...
const sections: Section[] = [
  ...
  },
  {
    ...
    groupBlurb: "Processing massive datasets, managing workflows, and building scalable data pipelines.",
    topics: [
      {
        slug: "batch-processing",
        title: "Batch Processing",
        blurb: "Processing large, bounded datasets for historical analysis.",
        icon: HardDrive,
        modules: ["Hadoop & HDFS", "MapReduce", "Spark Architecture", "Job Scheduling"],
        unlocked: false,
      ...
      },
      {
        ...
        blurb: "Real-time data processing and event streaming.",
        icon: Zap,
        modules: ["Apache Kafka", "Event Sourcing", "Stream vs Batch", "Real-time Analytics"],
        unlocked: false,
        routeBase: "data-engineering",
      },
      {
        ...
        blurb: "Managing workflows, data lineage, and ETL/ELT transformations.",
        icon: Network,
        modules: ["Airflow & DAGs", "ETL vs ELT", "Data Lineage", "Idempotency"],
        unlocked: false,
        routeBase: "data-engineering",
      },
      {
        ...
        blurb: "Centralized storage architectures for analytics.",
        icon: Database,
        modules: ["Data Warehouses vs Lakes", "Star vs Snowflake Schema", "Columnar Storage (Parquet)", "Redshift & BigQuery"],
        unlocked: false,
        routeBase: "data-engineering",
      },
    ],
